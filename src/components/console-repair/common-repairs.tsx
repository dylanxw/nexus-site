...
import { Gamepad2, Zap, Thermometer, HardDrive, Wifi, Settings } from "lucide-react";
...
const repairs = [
  {
    ...
    price: "From $89-149",
    description: "Console not displaying on TV? We repair and replace faulty HDMI ports on all gaming consoles including PlayStation, Xbox, and Nintendo Switch.",
    time: "2-3 hours",
    link: "/services/console-repair/hdmi-port-repair"
  },
  {
    id: 2,
    icon: Thermometer,
    ...
    price: "From $79-159",
    description: "Console overheating or shutting down? We clean cooling systems, replace thermal paste, and fix fan issues to keep your console running cool.",
    time: "1-2 hours",
    link: "/services/console-repair/overheating-repair"
  },
  {
    id: 3,
    icon: Zap,
    ...
    price: "From $99-189",
    description: "Console won't turn on or randomly powers off? We diagnose and repair power supply issues with quality replacement parts.",
    time: "2-3 hours",
    link: "/services/console-repair/power-supply-repair"
  },
  {
    id: 4,
    icon: HardDrive,
    ...
    price: "From $79-199",
    description: "Games won't load or disc drive making noise? We repair and replace disc drives for all console models with precision calibration.",
    time: "2-4 hours",
    link: "/services/console-repair/disc-drive-repair"
  },
  {
    id: 5,
    icon: Wifi,
    ...
    price: "From $69-129",
    description: "Can't connect to WiFi or online gaming? We fix network connectivity issues, WiFi modules, and ethernet port problems.",
    time: "1-2 hours",
    link: "/services/console-repair/network-repair"
  },
  {
    id: 6,
    icon: Settings,
    title: "System Software Issues",
    price: "From $59-99",
    description: "Console freezing, crashing, or won't boot? We diagnose and repair software corruption, firmware issues, and system crashes.",
    time: "1-3 hours",
    link: "/services/console-repair/software-repair"
  }
];

export function CommonConsoleRepairs() {
  return (
      ...
      <div className="wide-container relative z-10">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4 text-gray-900">
            Game Console Repair Services in Denton, TX
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Professional gaming console repair with same-day service, quality parts, and 60-day warranty
          </p>
        </div>
          ...
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-8 shadow-lg hover:bg-white/80 transition-all duration-300 group relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h3 className="text-xl font-bold text-gray-900 mb-2">
                Don't See Your Console Issue Listed?
              </h3>
              <p className="text-gray-600 mb-4">
                We repair all gaming console problems. Call for a free diagnostic and quote.
              </p>
