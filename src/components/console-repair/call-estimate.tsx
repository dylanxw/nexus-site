...
export function CallEstimateConsole() {
  return (
      ...
      <div className="wide-container relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6 text-gray-900">
            Ready to Fix Your Gaming Console?
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
            Get an instant estimate for your gaming console repair. Call now or visit our Denton store for same-day service on all console brands.
          </p>
          ...
          {[
            {
              ...
              description: "Most console repairs completed in 2-4 hours"
            },
            {
              icon: Shield,
              title: "60-Day Warranty",
              description: "All gaming console repairs guaranteed for 60 days"
            },
            {
              icon: CheckCircle,
              title: "Quality Parts",
              description: "High-quality parts for all gaming console brands"
            },
            {
              icon: Star,
              title: "Expert Service",
              description: "4.9/5 stars from 120+ console repairs"
            }
          ].map((feature, index) => {
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-6 text-center hover:bg-white/80 hover:shadow-xl transition-all duration-300 group relative overflow-hidden flex flex-col h-full">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <p className="text-gray-600 mb-4 text-sm flex-grow">
                Speak with our gaming console repair experts and get pricing over the phone
              </p>
              <a
          ...
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-6 text-center hover:bg-white/80 hover:shadow-xl transition-all duration-300 group relative overflow-hidden flex flex-col h-full">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <p className="text-gray-600 mb-4 text-sm flex-grow">
                Walk-in for free diagnostic and same-day gaming console repair service
              </p>
              <a
          ...
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-6 text-center hover:bg-white/80 hover:shadow-xl transition-all duration-300 group relative overflow-hidden flex flex-col h-full">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <p className="text-gray-600 mb-4 text-sm flex-grow">
                Get an estimate online and schedule your gaming console repair appointment
              </p>
          ...
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-6 relative overflow-hidden group hover:bg-white/80 hover:shadow-xl transition-all duration-300">
            ...
            <div className="relative z-10">
              <p className="text-lg font-semibold mb-2 text-gray-900">
                ⚡ Don't wait! The longer you wait, the more damage can occur to your gaming console.
              </p>
              <p className="text-gray-600">
                Call now for same-day repair service and get your console back to perfect gaming condition today.
              </p>
            </div>
          </div>
        </div>
