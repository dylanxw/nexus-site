...
const features = [
  {
    ...
    description: "Most gaming console repairs completed in 2-4 hours. Walk-in and scheduled appointments available."
  },
  {
    icon: Shield,
    title: "60-Day Warranty",
    description: "All gaming console repairs backed by our comprehensive 60-day warranty on parts and labor."
  },
  {
    icon: Award,
    title: "Quality Parts",
    description: "We use only high-quality replacement parts that meet or exceed original gaming console specifications."
  },
  {
    icon: Users,
    title: "Expert Technicians",
    description: "Certified technicians with specialized training in PlayStation, Xbox, Nintendo, and PC gaming repairs."
  },
  {
    icon: Wrench,
    title: "All Console Types",
    description: "We repair all gaming consoles: PlayStation, Xbox, Nintendo, retro consoles, and gaming PCs."
  },
  {
    icon: CheckCircle,
    title: "Free Diagnostics",
    description: "Comprehensive diagnostic testing at no charge to identify exactly what needs repair on your console."
  }
];

export function WhyChooseConsole() {
  return (
      ...
      <div className="wide-container relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6 text-gray-900">
            Why Choose Nexus Tech for Gaming Console Repair?
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            With over 1,200+ gaming consoles repaired and a 97% success rate, we're Denton's trusted gaming console repair experts.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16">
          {[
            { number: "1,200+", label: "Consoles Repaired" },
