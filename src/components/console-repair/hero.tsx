...
import { Phone, MessageSquare, Clock, Shield, CheckCircle, Star, Gamepad2 } from "lucide-react";
import { siteConfig } from "@/config/site";

export function GameConsoleRepairHero() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6 text-gray-900">
              Game Console Repair <span className="text-[#DB5858]">Denton, TX</span>
            </h1>

            <p className="text-xl text-gray-600 mb-6 leading-relaxed">
              Expert game console repair with same-day service, quality parts, and 60-day warranty. Professional technicians for PlayStation, Xbox, Nintendo Switch, and all gaming consoles.
            </p>
            ...
            <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-6 mb-8 shadow-lg">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Common Game Console Repairs:</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-[#DB5858] rounded-full mr-2"></div>
                  <span className="text-gray-600">HDMI port repair</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-[#DB5858] rounded-full mr-2"></div>
                ...
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-[#DB5858] rounded-full mr-2"></div>
                  <span className="text-gray-600">Power problems</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-[#DB5858] rounded-full mr-2"></div>
                  <span className="text-gray-600">Disc drive repair</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-[#DB5858] rounded-full mr-2"></div>
                  <span className="text-gray-600">Controller issues</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-[#DB5858] rounded-full mr-2"></div>
                  <span className="text-gray-600">System crashes</span>
                </div>
              </div>
            </div>
          ...
          <div className="relative">
            <div className="relative max-w-md mx-auto">
              <Image
                src="/images/game-console-repair/game-console-repair-services.png"
                alt="Game console repair services in Denton TX"
                width={448}
                height={336}
