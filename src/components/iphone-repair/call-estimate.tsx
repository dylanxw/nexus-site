      ...
      <div className="wide-container relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
            Get an instant estimate for your iPhone repair. Call now or visit our Denton store for same-day service.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-6 text-center hover:bg-white/80 hover:shadow-xl transition-all duration-300 group relative overflow-hidden flex flex-col h-full">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <p className="text-gray-600 mb-4 text-sm flex-grow">
                Speak with our iPhone repair experts and get pricing over the phone
              </p>
              <a
          ...
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-6 text-center hover:bg-white/80 hover:shadow-xl transition-all duration-300 group relative overflow-hidden flex flex-col h-full">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <p className="text-gray-600 mb-4 text-sm flex-grow">
                Walk-in for free diagnostic and same-day iPhone repair service
              </p>
              <a
          ...
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-6 text-center hover:bg-white/80 hover:shadow-xl transition-all duration-300 group relative overflow-hidden flex flex-col h-full">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <p className="text-gray-600 mb-4 text-sm flex-grow">
                Get an estimate online and schedule your iPhone repair appointment
              </p>
          ...
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-6 relative overflow-hidden group hover:bg-white/80 hover:shadow-xl transition-all duration-300">
            ...
            <div className="relative z-10">
              <p className="text-lg font-semibold mb-2 text-gray-900">
                ⚡ Don't wait! The longer you wait, the more damage can occur to your iPhone.
              </p>
              <p className="text-gray-600">
                Call now for same-day repair service and get your iPhone back to perfect condition today.
              </p>
            </div>
          </div>
        </div>
