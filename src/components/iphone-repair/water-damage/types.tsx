  ...
  return (
    <section className="section-padding relative overflow-hidden" style={{
      ...
      <div className="wide-container relative z-10">
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  <div className="flex items-center gap-2 lg:gap-3 mb-3 lg:mb-4">
                    <div className={`w-10 h-10 lg:w-12 lg:h-12 rounded-lg lg:rounded-xl ${type.bgColor} flex items-center justify-center shadow-lg`}>
                      <Icon className="h-5 w-5 lg:h-6 lg:w-6 text-gray-700" />
                    </div>
                    <div>
                      <h3 className="text-base lg:text-xl font-bold text-gray-900">{type.title}</h3>
                      <div className="flex items-center gap-2">
                        <span className="text-xs lg:text-sm text-gray-500">Severity:</span>
                        <span className={`text-xs lg:text-sm font-bold ${type.severityColor}`}>{type.severity}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mb-3 lg:mb-4">
                    <div className="flex justify-between items-center mb-2 lg:mb-3">
                      <span className="text-xs lg:text-sm font-semibold text-gray-900">Recovery Rate:</span>
                      <span className="text-xs lg:text-sm font-bold text-green-600">{type.recovery}</span>
                    </div>

                    <h4 className="font-semibold text-gray-900 mb-2 text-xs lg:text-sm">Common Examples:</h4>
        ...
        >
          <div className="backdrop-blur-md bg-red-50/60 border border-red-200/80 rounded-xl lg:rounded-2xl p-6 lg:p-8 hover:bg-red-50/80 hover:shadow-xl transition-all duration-300 group relative overflow-hidden">
            <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-white/40 to-transparent transform -translate-x-full opacity-0 group-hover:opacity-100 group-hover:translate-x-full transition-all duration-1000 ease-out"></div>
            <div className="relative z-10">
              <h3 className="text-xl lg:text-3xl font-bold mb-3 lg:mb-4 text-red-800">
                What to Do Immediately After Water Damage
              </h3>

              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mt-6 lg:mt-8">
                <div className="text-center">
                  <div className="w-10 h-10 lg:w-12 lg:h-12 bg-red-500/10 rounded-lg lg:rounded-xl flex items-center justify-center mx-auto mb-2 lg:mb-3">
                    <span className="text-lg lg:text-xl font-bold text-red-600">1</span>
                  </div>
                  <h4 className="font-semibold text-red-800 mb-2 text-xs lg:text-sm">Power Off</h4>
                  <p className="text-xs text-red-700">Turn off your iPhone immediately and do not attempt to charge it.</p>
                </div>

                <div className="text-center">
                  <div className="w-10 h-10 lg:w-12 lg:h-12 bg-red-500/10 rounded-lg lg:rounded-xl flex items-center justify-center mx-auto mb-2 lg:mb-3">
                    <span className="text-lg lg:text-xl font-bold text-red-600">2</span>
                  </div>
                  <h4 className="font-semibold text-red-800 mb-2 text-xs lg:text-sm">Remove Case</h4>
                  <p className="text-xs text-red-700">Remove case and SIM card if possible to allow better air circulation.</p>
                </div>

                <div className="text-center">
                  <div className="w-10 h-10 lg:w-12 lg:h-12 bg-red-500/10 rounded-lg lg:rounded-xl flex items-center justify-center mx-auto mb-2 lg:mb-3">
                    <span className="text-lg lg:text-xl font-bold text-red-600">3</span>
                  </div>
                  <h4 className="font-semibold text-red-800 mb-2 text-xs lg:text-sm">Dry Gently</h4>
                  <p className="text-xs text-red-700">Pat dry with soft cloth but avoid shaking or using heat sources.</p>
                </div>

                <div className="text-center">
                  <div className="w-10 h-10 lg:w-12 lg:h-12 bg-red-500/10 rounded-lg lg:rounded-xl flex items-center justify-center mx-auto mb-2 lg:mb-3">
                    <span className="text-lg lg:text-xl font-bold text-red-600">4</span>
                  </div>
                  <h4 className="font-semibold text-red-800 mb-2 text-xs lg:text-sm">Bring to Us</h4>
                  <p className="text-xs text-red-700">Bring to our Denton location immediately for professional assessment.</p>
                </div>
              </div>

              <div className="mt-6 lg:mt-8">
                <button className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white px-6 lg:px-8 py-2.5 lg:py-3 rounded-lg text-sm lg:text-base font-semibold transition-all duration-300 shadow-lg hover:shadow-xl">
