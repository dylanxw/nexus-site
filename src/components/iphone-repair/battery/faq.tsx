            ...
            {batteryFAQs.map((faq, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="w-full p-6 text-left flex items-center justify-between rounded-2xl group relative z-10"
                >
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-xl bg-green-500/10 backdrop-blur-sm flex items-center justify-center group-hover:bg-green-500/20" style={{ transition: 'background-color 0.3s ease' }}>
