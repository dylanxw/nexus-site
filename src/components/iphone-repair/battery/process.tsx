    ...
    <section className="section-padding relative overflow-hidden" style={{
      ...
      <div className="wide-container relative z-10">
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-green-500/10 rounded-2xl mb-4 backdrop-blur-sm group-hover:bg-green-500/20" style={{ transition: 'background-color 0.3s ease' }}>
          ...
          <div className="relative z-10 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2">Quality Batteries</h4>
                <p className="text-sm text-gray-600">We use high-quality replacement batteries that meet or exceed original specifications, plus OEM Original and genuine options available.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2">Fast Service</h4>
                <p className="text-sm text-gray-600">Most battery replacements completed in 30-45 minutes while you wait.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2">60-Day Warranty</h4>
                <p className="text-sm text-gray-600">All battery replacements include our comprehensive 60-day warranty coverage.</p>
              </div>
            </div>
        ...
        <motion.div
          ...
          className="mt-12"
        >
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-8 hover:bg-white/80 hover:shadow-xl group relative overflow-hidden" style={{ transition: 'background-color 0.3s ease, box-shadow 0.3s ease' }}>
            <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-white/40 to-transparent transform -translate-x-full opacity-0 group-hover:opacity-100 group-hover:translate-x-full transition-all duration-1000 ease-out"></div>
            ...
            <div className="relative z-10">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Battery Drains Quickly</h4>
                    <p className="text-sm text-gray-600">Your iPhone battery doesn't last through the day like it used to.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Unexpected Shutdowns</h4>
                    <p className="text-sm text-gray-600">iPhone turns off suddenly even with battery percentage remaining.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Takes much longer to charge than when your iPhone was new.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Battery Health Below 80%</h4>
                    <p className="text-sm text-gray-600">iOS shows battery health significantly degraded in Settings.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Overheating Issues</h4>
                    <p className="text-sm text-gray-600">iPhone gets unusually hot during normal use or charging.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Performance Throttling</h4>
                    <p className="text-sm text-gray-600">iPhone feels slower due to iOS battery management features.</p>
                  </div>
                </div>
              </div>
            </div>
