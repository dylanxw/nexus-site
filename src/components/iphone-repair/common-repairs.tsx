...
const repairs = [
  {
    ...
    price: "From $79",
    description: "Cracked or shattered screen? We replace damaged iPhone screens with quality parts including genuine options. Same-day service available for most models.",
    time: "30-45 mins",
    link: "/services/iphone-repair/screen-replacement"
  },
  {
    id: 2,
    icon: Battery,
    ...
    price: "From $59",
    description: "Battery draining fast? We replace worn iPhone batteries with quality batteries that restore battery life.",
    time: "30-45 mins",
    link: "/services/iphone-repair/battery-replacement"
  },
  {
    id: 3,
    icon: Droplets,
    ...
    price: "From $99",
    description: "Dropped in water? We use professional cleaning techniques to remove moisture and corrosion from internal components.",
    time: "2-3 hours",
    link: "/services/iphone-repair/water-damage-repair"
  },
  {
    id: 4,
    icon: Zap,
    ...
    price: "From $69",
    description: "iPhone not charging? We repair and replace faulty Lightning charging ports with precision micro-soldering.",
    time: "1-2 hours",
    link: "/services/iphone-repair/charging-port-repair"
  },
  {
    id: 5,
    icon: Camera,
    title: "Camera Repair",
    price: "From $89",
    description: "Blurry photos or camera issues? We repair front and rear cameras, replacing lenses and sensors as needed.",
    time: "1-2 hours",
    link: "/services/iphone-repair/camera-repair"
  },
  {
    id: 6,
    icon: RefreshCw,
    ...
    price: "From $79",
    description: "Cracked back glass? We offer housing swap with OEM Apple parts or glass-only replacement for budget-friendly repair.",
    time: "1-3 hours",
    link: "/services/iphone-repair/back-glass-repair"
  }
];
      ...
      <div className="wide-container relative z-10">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4 text-gray-900">
            iPhone Repair Services in Denton, TX
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Same-day repair service with quality parts and 60-day warranty
          </p>
        </div>
          ...
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-8 shadow-lg hover:bg-white/80 transition-all duration-300 group relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h3 className="text-xl font-bold text-gray-900 mb-2">
                Don't See Your iPhone Issue Listed?
              </h3>
