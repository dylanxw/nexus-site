            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="inline-flex items-center justify-center w-12 h-12 lg:w-16 lg:h-16 bg-yellow-500/10 rounded-xl lg:rounded-2xl mb-3 lg:mb-4 backdrop-blur-sm group-hover:bg-yellow-500/20 transition-colors">
                    <Icon className="h-6 w-6 lg:h-8 lg:w-8 text-yellow-600" />
                  </div>

                  <div className="text-xs lg:text-sm font-bold text-yellow-600 mb-1 lg:mb-2">Step {step.step}</div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6 mt-6 lg:mt-8">
              <div className="text-center">
                <div className="w-10 h-10 lg:w-12 lg:h-12 bg-purple-500/10 rounded-lg lg:rounded-xl flex items-center justify-center mx-auto mb-2 lg:mb-3">
                  <Brush className="h-5 w-5 lg:h-6 lg:w-6 text-purple-600" />
                </div>
                <h4 className="font-semibold text-gray-900 mb-2 text-sm lg:text-base">Cleaning & Replacement</h4>
                <p className="text-xs lg:text-sm text-gray-600">Professional debris removal or complete port replacement based on diagnostic findings.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2 text-sm lg:text-base">Lightning & USB-C Specialist</h4>
                <p className="text-xs lg:text-sm text-gray-600">Expert repair for both Lightning and USB-C charging ports across all iPhone models.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2 text-sm lg:text-base">Quality Guarantee</h4>
                <p className="text-xs lg:text-sm text-gray-600">60-day warranty on all charging port repairs with thorough testing before return.</p>
              </div>
            </div>
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
                <div className="flex items-start gap-2 lg:gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Cable Won't Go In Fully</h4>
                    <p className="text-xs lg:text-sm text-gray-600">Charging cable stops partway when inserting, often due to lint or debris buildup.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 lg:gap-3">
                  <div className="w-5 h-5 lg:w-6 lg:h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Loose Connection</h4>
                    <p className="text-xs lg:text-sm text-gray-600">Charging cable falls out easily or requires specific positioning to charge.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 lg:gap-3">
                  <div className="w-5 h-5 lg:w-6 lg:h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Intermittent Charging</h4>
                    <p className="text-xs lg:text-sm text-gray-600">Charging stops and starts randomly, or only works with certain cables.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 lg:gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs lg:text-sm text-gray-600">Takes much longer to charge than normal, even with fast chargers.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 lg:gap-3">
                  <div className="w-5 h-5 lg:w-6 lg:h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Physical Damage</h4>
                    <p className="text-xs lg:text-sm text-gray-600">Visible damage to the charging port from drops or foreign objects.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 lg:gap-3">
                  <div className="w-5 h-5 lg:w-6 lg:h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Data Transfer Issues</h4>
                    <p className="text-xs lg:text-sm text-gray-600">Can't connect to computer or transfer data despite charging working.</p>
                  </div>
                </div>
              </div>
            </div>
