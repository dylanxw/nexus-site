              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  <div className="flex items-center gap-3 mb-3 lg:mb-4">
                    <div className="w-10 h-10 lg:w-12 lg:h-12 rounded-lg lg:rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center shadow-lg">
                  ...
                  <div className="mb-3 lg:mb-4">
                    <h4 className="font-semibold text-gray-900 mb-2 text-xs lg:text-sm">Best For:</h4>
                  ...
                  <div className="mb-3 lg:mb-4">
                    <h4 className="font-semibold text-gray-900 mb-2 text-xs lg:text-sm">Benefits:</h4>
                    <div className="space-y-1">
                      {type.benefits.map((benefit, benefitIndex) => (
                        <div key={benefitIndex} className="flex items-center text-xs lg:text-sm text-gray-600">
