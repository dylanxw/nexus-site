            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="inline-flex items-center justify-center w-12 h-12 lg:w-16 lg:h-16 bg-purple-500/10 rounded-xl lg:rounded-2xl mb-3 lg:mb-4 backdrop-blur-sm group-hover:bg-purple-500/20 transition-colors">
                    <Icon className="h-6 w-6 lg:h-8 lg:w-8 text-purple-600" />
                  </div>

                  <div className="text-xs lg:text-sm font-bold text-purple-600 mb-1 lg:mb-2">Step {step.step}</div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6 mt-6 lg:mt-8">
              <div className="text-center">
                <div className="w-10 h-10 lg:w-12 lg:h-12 bg-purple-500/10 rounded-lg lg:rounded-xl flex items-center justify-center mx-auto mb-2 lg:mb-3">
                  <RefreshCw className="h-5 w-5 lg:h-6 lg:w-6 text-purple-600" />
                </div>
                <h4 className="font-semibold text-gray-900 mb-2 text-sm lg:text-base">OEM Housing Available</h4>
                <p className="text-xs lg:text-sm text-gray-600">Genuine Apple housings available for maximum durability and like-new appearance.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-xs lg:text-sm text-gray-600">60-day warranty on all back glass repairs with professional installation.</p>
              </div>
              ...
              <div className="text-center">
                <div className="w-10 h-10 lg:w-12 lg:h-12 bg-blue-500/10 rounded-lg lg:rounded-xl flex items-center justify-center mx-auto mb-2 lg:mb-3">
                  <Smartphone className="h-5 w-5 lg:h-6 lg:w-6 text-blue-600" />
                </div>
                <h4 className="font-semibold text-gray-900 mb-2 text-sm lg:text-base">Function Preservation</h4>
                <p className="text-xs lg:text-sm text-gray-600">Wireless charging, camera, and all functions maintained after repair.</p>
              </div>
            </div>
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
                <div className="flex items-start gap-2 lg:gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Cracked Back Glass</h4>
                    <p className="text-xs lg:text-sm text-gray-600">Visible cracks or spider web patterns across the back panel.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 lg:gap-3">
                  <div className="w-5 h-5 lg:w-6 lg:h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Shattered Glass</h4>
                    <p className="text-xs lg:text-sm text-gray-600">Glass pieces falling out or completely shattered back panel.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 lg:gap-3">
                  <div className="w-5 h-5 lg:w-6 lg:h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Wireless Charging Issues</h4>
                    <p className="text-xs lg:text-sm text-gray-600">Wireless charging no longer works or charges intermittently.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 lg:gap-3">
                  <div className="w-5 h-5 lg:w-6 lg:h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Camera Lens Damage</h4>
                    <p className="text-xs lg:text-sm text-gray-600">Camera lens protector cracked or damaged around camera area.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 lg:gap-3">
                  <div className="w-5 h-5 lg:w-6 lg:h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Back Panel Separation</h4>
                    <p className="text-xs lg:text-sm text-gray-600">Back glass lifting or separating from the frame.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 lg:gap-3">
                  <div className="w-5 h-5 lg:w-6 lg:h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Sharp Edges</h4>
                    <p className="text-xs lg:text-sm text-gray-600">Dangerous sharp glass edges that could cause cuts.</p>
                  </div>
                </div>
              </div>
            </div>
