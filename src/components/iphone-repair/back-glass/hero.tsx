...
import { Phone, MessageSquare, Clock, Shield, Smartphone, AlertTriangle } from "lucide-react";
import { siteConfig } from "@/config/site";

export function IPhoneBackGlassHero() {
  return (
    <section className="py-8 lg:py-16 relative overflow-hidden" style={{
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-10 w-40 h-40 bg-purple-500/5 rounded-full blur-2xl animate-pulse"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-4 lg:mb-6 text-gray-900">
              iPhone <span className="text-[#DB5858]">Back Glass Repair</span> Denton, TX
            </h1>

            <p className="text-base lg:text-xl text-gray-600 mb-4 lg:mb-6 leading-relaxed">
              Fix cracked iPhone back glass with professional housing swap or glass-only replacement. OEM Apple housings available for maximum durability.
            </p>
            ...
            <div className="flex flex-wrap gap-2 lg:gap-4 mb-6 lg:mb-8">
              <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-lg lg:rounded-xl px-3 py-1.5 lg:px-4 lg:py-2 flex items-center">
                <Smartphone className="h-3 w-3 lg:h-4 lg:w-4 mr-1.5 lg:mr-2 text-purple-500" />
                <span className="font-semibold text-gray-800 text-xs lg:text-sm">Housing Swap & Glass Only</span>
              </div>
              <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-lg lg:rounded-xl px-3 py-1.5 lg:px-4 lg:py-2 flex items-center">
            ...
            <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-xl lg:rounded-2xl p-4 lg:p-6 mb-6 lg:mb-8 shadow-lg">
              <h3 className="text-base lg:text-lg font-bold text-gray-900 mb-3 lg:mb-4">Common Back Glass Issues We Fix:</h3>
              <div className="grid grid-cols-2 gap-2 lg:gap-3 text-xs lg:text-sm">
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-purple-500 rounded-full mr-2"></div>
                  <span className="text-gray-600">Cracked back glass</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-purple-500 rounded-full mr-2"></div>
                  <span className="text-gray-600">Shattered back panel</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-purple-500 rounded-full mr-2"></div>
                  <span className="text-gray-600">Camera lens protector damage</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-purple-500 rounded-full mr-2"></div>
                  <span className="text-gray-600">Wireless charging issues</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-purple-500 rounded-full mr-2"></div>
                  <span className="text-gray-600">Glass falling out</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-purple-500 rounded-full mr-2"></div>
                  <span className="text-gray-600">Back panel separation</span>
                </div>
              </div>
            </div>
          ...
          >
            <div className="relative">
              <img
                src="/images/iphone-repair/iphone-back-glass-replacement.jpg"
                alt="iPhone back glass repair service in Denton TX - Housing swap and glass replacement"
                className="w-full h-auto max-w-md mx-auto rounded-xl lg:rounded-2xl"
              />

              {/* OEM Housing badge */}
              <div className="absolute top-3 right-3 lg:top-4 lg:right-4 bg-purple-500 text-white px-3 py-1.5 lg:px-4 lg:py-2 rounded-full shadow-lg">
                <div className="text-center">
                  <div className="text-xs lg:text-sm font-bold">OEM Apple</div>
                  <div className="text-xs">Housing Available</div>
                </div>
              </div>
              ...
              <div className="absolute bottom-3 left-3 lg:bottom-4 lg:left-4 bg-white border border-gray-200 px-3 py-1.5 lg:px-4 lg:py-2 rounded-lg shadow-lg">
                <div className="flex items-center gap-2">
                  <Clock className="h-3 w-3 lg:h-4 lg:w-4 text-green-500" />
