          ...
          >
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-xl px-4 py-2 flex items-center">
                ...
                <span className="font-semibold text-gray-800 text-sm">Housing Swap & Glass Only</span>
              </div>
              <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-xl px-4 py-2 flex items-center">
            ...
            <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-6 mb-8 shadow-lg">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Common Back Glass Issues We Fix:</h3>
            ...
            <div className="relative">
              ...
              <div className="absolute top-4 right-4 bg-purple-500 text-white px-4 py-2 rounded-full shadow-lg">
                <div className="text-center">
                  <div className="text-sm font-bold">OEM Apple</div>
