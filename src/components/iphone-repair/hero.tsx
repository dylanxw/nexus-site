...
export function IPhoneRepairHero() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-4 lg:mb-6 text-gray-900">
              iPhone Repair <span className="text-[#DB5858]">Denton, TX</span>
            </h1>

            <p className="text-base md:text-lg lg:text-xl text-gray-600 mb-4 lg:mb-6 leading-relaxed">
              Same-day iPhone repair with quality parts and 60-day warranty. Expert technicians serving all iPhone models.
            </p>
            ...
            <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-xl lg:rounded-2xl p-4 lg:p-6 mb-6 lg:mb-8 shadow-lg">
              <h3 className="text-base lg:text-lg font-bold text-gray-900 mb-3 lg:mb-4">Common Repairs We Fix:</h3>
