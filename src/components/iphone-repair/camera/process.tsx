          ...
          <div className="relative z-10 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2">OEM Camera Parts</h4>
                <p className="text-sm text-gray-600">We use only OEM camera modules and lens components. No aftermarket parts for camera repairs.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2">Face ID Preservation</h4>
                <p className="text-sm text-gray-600">Apple original front camera parts for iPhone 12+ to maintain Face ID functionality.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2">Camera Pairing</h4>
                <p className="text-sm text-gray-600">Professional camera pairing service for full functionality and optimal performance.</p>
              </div>
            </div>
            ...
            <div className="relative z-10">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Blurry Photos</h4>
                    <p className="text-sm text-gray-600">Photos are consistently blurry or out of focus, even with good lighting.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Cracked Lens</h4>
                    <p className="text-sm text-gray-600">Visible cracks or damage to the camera lens glass affecting photo quality.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Black Screen</h4>
                    <p className="text-sm text-gray-600">Camera app shows black screen or won't open at all.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Won't Focus</h4>
                    <p className="text-sm text-gray-600">Camera struggles to focus or makes clicking sounds when trying to focus.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Flash Issues</h4>
                    <p className="text-sm text-gray-600">Camera flash doesn't work or only works intermittently.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Face ID Problems</h4>
                    <p className="text-sm text-gray-600">Face ID stopped working after front camera damage or replacement.</p>
                  </div>
                </div>
              </div>
            </div>
