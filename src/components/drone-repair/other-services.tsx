            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <p className="text-gray-600 text-xs lg:text-sm leading-relaxed mb-3 lg:mb-4 flex-grow hidden lg:block">
                    {service.description}
                  </p>

                  <a href={service.link} className="mt-auto">
                    <button
                      className="w-full py-2 px-4 rounded-lg font-semibold transition-all duration-300 text-xs lg:text-sm shadow-lg hover:shadow-xl bg-gradient-to-r from-[#DB5858] to-[#c94848] hover:from-[#c94848] hover:to-[#b83d3d] text-white"
                    >
                      Learn More
                    </button>
                  </a>
