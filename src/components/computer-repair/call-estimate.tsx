...
export function CallEstimateComputer() {
  return (
      ...
      <div className="wide-container relative z-10">
        <div className="text-center mb-8 lg:mb-16">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight mb-3 lg:mb-6 text-gray-900">
            Ready to Fix Your Computer or Laptop?
          </h2>
          <p className="text-base lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-4 lg:mb-8">
            Get an instant estimate for your computer or laptop repair. Call now or visit our Denton store for same-day service on all computer brands.
          </p>

          {/* Main CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-3 lg:gap-6 justify-center max-w-2xl mx-auto mb-6 lg:mb-12">
            <Button
              size="lg"
              asChild
          ...
          {[
            {
              ...
              description: "Most computer repairs completed in 2-4 hours"
            },
            {
              icon: Shield,
              title: "60-Day Warranty",
              description: "All computer & laptop repairs guaranteed for 60 days"
            },
            {
              icon: CheckCircle,
              title: "Quality Parts",
              description: "High-quality parts for all computer & laptop brands"
            },
            {
              icon: Star,
              title: "Expert Service",
              description: "4.9/5 stars from 200+ computer repairs"
            }
          ].map((feature, index) => {
              ...
              >
                <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-xl lg:rounded-2xl p-4 lg:p-6 hover:bg-white/80 hover:shadow-xl transition-all duration-300 group relative overflow-hidden h-full flex flex-col">
                  ...
                  <div className="relative z-10 text-center flex flex-col h-full">
                    ...
                    <h3 className="text-sm lg:text-lg font-bold mb-2 text-gray-900">{feature.title}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-8">
          ...
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-xl lg:rounded-2xl p-4 lg:p-6 text-center hover:bg-white/80 hover:shadow-xl transition-all duration-300 group relative overflow-hidden flex flex-col h-full">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <p className="text-gray-600 mb-3 lg:mb-4 text-xs lg:text-sm flex-grow">
                Speak with our computer & laptop repair experts and get pricing over the phone
              </p>
              <a
                href={`tel:${siteConfig.phone}`}
                className="inline-block bg-gradient-to-r from-[#DB5858] to-[#c94848] text-white px-4 py-2 lg:px-6 lg:py-3 rounded-lg text-sm lg:text-base font-semibold hover:from-[#c94848] hover:to-[#b83d3d] transition-all duration-300 shadow-lg hover:shadow-xl mt-auto"
              >
                {siteConfig.phone}
              </a>
            </div>
          ...
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-xl lg:rounded-2xl p-4 lg:p-6 text-center hover:bg-white/80 hover:shadow-xl transition-all duration-300 group relative overflow-hidden flex flex-col h-full">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <p className="text-gray-600 mb-3 lg:mb-4 text-xs lg:text-sm flex-grow">
                Walk-in for free diagnostic and same-day computer & laptop repair service
              </p>
              <a
          ...
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-xl lg:rounded-2xl p-4 lg:p-6 text-center hover:bg-white/80 hover:shadow-xl transition-all duration-300 group relative overflow-hidden flex flex-col h-full">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <p className="text-gray-600 mb-3 lg:mb-4 text-xs lg:text-sm flex-grow">
                Get an estimate online and schedule your computer or laptop repair appointment
              </p>
              <button className="bg-gradient-to-r from-[#DB5858] to-[#c94848] text-white px-4 py-2 lg:px-6 lg:py-3 rounded-lg text-sm lg:text-base font-semibold hover:from-[#c94848] hover:to-[#b83d3d] transition-all duration-300 shadow-lg hover:shadow-xl mt-auto">
                Get Quote
              </button>
            </div>
          </div>
          ...
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-xl lg:rounded-2xl p-4 lg:p-6 relative overflow-hidden group hover:bg-white/80 hover:shadow-xl transition-all duration-300">
            ...
            <div className="relative z-10">
              <p className="text-sm lg:text-lg font-semibold mb-1 lg:mb-2 text-gray-900">
                ⚡ Don't wait! The longer you wait, the more damage can occur to your computer or laptop.
              </p>
              <p className="text-gray-600 text-xs lg:text-base">
                Call now for same-day repair service and get your computer back to perfect working condition today.
              </p>
            </div>
          </div>
        </div>
