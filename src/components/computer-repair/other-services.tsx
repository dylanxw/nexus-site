...
import { Smartphone, Gamepad2, HardDrive, Tablet } from "lucide-react";
...
const otherServices = [
  ...
  },
  {
    ...
    icon: HardDrive,
    title: "Data Recovery",
    description: "Professional data recovery services for computers, laptops, phones, and external storage devices.",
    link: "#" // Will be updated when pages are created
  }
];

export function OtherComputerServices() {
  return (
      ...
      <div className="wide-container relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Beyond computer and laptop repair, we fix all your tech devices with the same quality and expertise
          </p>
        </div>
