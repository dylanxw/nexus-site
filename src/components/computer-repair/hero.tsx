...
import { Phone, MessageSquare, Clock, Shield, CheckCircle, Star, Laptop } from "lucide-react";
import { siteConfig } from "@/config/site";

export function ComputerRepairHero() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
          ...
          <div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-3 lg:mb-6 text-gray-900">
              Computer & Laptop Repair <span className="text-[#DB5858]">Denton, TX</span>
            </h1>

            <p className="text-base lg:text-xl text-gray-600 mb-4 lg:mb-6 leading-relaxed">
              Expert computer and laptop repair with same-day service, quality parts, and 60-day warranty. Professional technicians for MacBook, PC, Windows laptops, and all computer systems.
            </p>
            ...
            <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-xl lg:rounded-2xl p-4 lg:p-6 mb-4 lg:mb-8 shadow-lg">
              <h3 className="text-base lg:text-lg font-bold text-gray-900 mb-3 lg:mb-4">Common Computer & Laptop Repairs:</h3>
              <div className="grid grid-cols-2 gap-2 lg:gap-3 text-xs lg:text-sm">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-600">Cracked laptop screens</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-[#DB5858] rounded-full mr-2"></div>
                  <span className="text-gray-600">Dead laptop batteries</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-[#DB5858] rounded-full mr-2"></div>
                  <span className="text-gray-600">Virus & malware removal</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-[#DB5858] rounded-full mr-2"></div>
                ...
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-[#DB5858] rounded-full mr-2"></div>
                  <span className="text-gray-600">Hard drive replacement</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-[#DB5858] rounded-full mr-2"></div>
                  <span className="text-gray-600">Keyboard repair</span>
                </div>
              </div>
            </div>
          ...
          <div className="relative">
            <div className="relative max-w-md mx-auto">
              <Image
                src="/images/laptop-computer-repair/laptop-computer-repair-services.jpg"
                alt="Computer and laptop repair services in Denton TX"
                width={448}
                height={336}
