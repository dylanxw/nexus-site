...
import { Laptop, Smartphone, Monitor, Gamepad2, HardDrive } from "lucide-react";
...
const otherServices = [
  ...
  },
  {
    ...
    icon: Smartphone,
    title: "iPhone Repair",
    description: "Complete iPhone repair services including screen replacement, charging port repair, and battery replacement.",
...
export function OtherTabletServices() {
  return (
      ...
      <div className="wide-container relative z-10">
        <div className="text-center mb-8 lg:mb-12">
          ...
          <p className="text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
            Beyond tablet repair, we fix all your tech devices with the same quality and expertise
          </p>
        </div>
