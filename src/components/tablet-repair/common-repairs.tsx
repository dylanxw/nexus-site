            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <button className="w-full bg-gradient-to-r from-[#DB5858] to-[#c94848] hover:from-[#c94848] hover:to-[#b83d3d] text-white py-2 lg:py-2.5 px-4 rounded-lg font-semibold transition-all duration-300 text-xs lg:text-sm shadow-lg hover:shadow-xl mt-auto">
                    Book Repair
                  </button>
                </div>
              </div>
