...
const features = [
  {
    ...
    description: "Most tablet repairs completed in 1-3 hours. Walk-in and scheduled appointments available."
  },
  {
    icon: Shield,
    title: "60-Day Warranty",
    description: "All tablet repairs backed by our comprehensive 60-day warranty on parts and labor."
  },
  {
    icon: Award,
    title: "Quality Parts",
    description: "We use only high-quality replacement parts that meet or exceed original specifications."
  },
  {
    icon: Users,
    title: "Expert Technicians",
    description: "Certified technicians with years of experience repairing all tablet brands and models."
  },
  {
    icon: Wrench,
    title: "All Brands Supported",
    description: "We repair tablets from every major brand: Apple, Samsung, Microsoft, Amazon, Lenovo, and more."
  },
  {
    icon: CheckCircle,
    title: "Free Diagnostics",
    description: "Comprehensive diagnostic testing at no charge to identify exactly what needs repair."
  }
];
      ...
      <div className="wide-container relative z-10">
        <div className="text-center mb-8 lg:mb-16">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight mb-3 lg:mb-6 text-gray-900">
            Why Choose Nexus Tech for Tablet Repair?
          </h2>
          <p className="text-base lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            With over 3,000+ tablets repaired and a 97% success rate, we're Denton's trusted tablet repair experts.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 lg:gap-8 mt-8 lg:mt-16">
          {[
            { number: "3,000+", label: "Tablets Repaired" },
