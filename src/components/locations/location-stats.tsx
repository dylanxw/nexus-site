    ...
    <section className="section-padding relative overflow-hidden" style={{
      ...
      <div className="wide-container relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {/* Repair Speed */}
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-8 text-center hover:bg-white/80 hover:shadow-xl transition-all duration-300 group">
            <div className="w-16 h-16 mx-auto mb-6 bg-[#DB5858]/10 rounded-2xl flex items-center justify-center group-hover:bg-[#DB5858]/20 transition-all duration-300">
              <Clock className="h-8 w-8 text-[#DB5858]" />
            </div>
            <div className="text-3xl font-bold text-gray-900 mb-2">Same Day</div>
            <div className="text-lg font-semibold text-gray-700 mb-3">Repair Service</div>
          ...
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-8 text-center hover:bg-white/80 hover:shadow-xl transition-all duration-300 group">
            ...
            <div className="text-3xl font-bold text-gray-900 mb-2">Lifetime</div>
            <div className="text-lg font-semibold text-gray-700 mb-3">Warranty</div>
            <p className="text-gray-600 text-sm">
          ...
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-8 text-center hover:bg-white/80 hover:shadow-xl transition-all duration-300 group">
            <div className="w-16 h-16 mx-auto mb-6 bg-[#DB5858]/10 rounded-2xl flex items-center justify-center group-hover:bg-[#DB5858]/20 transition-all duration-300">
              <Star className="h-8 w-8 text-[#DB5858]" />
            </div>
            <div className="text-3xl font-bold text-gray-900 mb-2">4.9/5</div>
            <div className="text-lg font-semibold text-gray-700 mb-3">Customer Rating</div>
            <p className="text-gray-600 text-sm">
          ...
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-8 text-center hover:bg-white/80 hover:shadow-xl transition-all duration-300 group">
            <div className="w-16 h-16 mx-auto mb-6 bg-[#DB5858]/10 rounded-2xl flex items-center justify-center group-hover:bg-[#DB5858]/20 transition-all duration-300">
              <Wrench className="h-8 w-8 text-[#DB5858]" />
            </div>
            <div className="text-3xl font-bold text-gray-900 mb-2">1,000+</div>
            <div className="text-lg font-semibold text-gray-700 mb-3">Devices Repaired</div>
            <p className="text-gray-600 text-sm">
          ...
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-8 text-center hover:bg-white/80 hover:shadow-xl transition-all duration-300 group">
            ...
            <div className="text-lg font-semibold text-gray-700 mb-3">Happy Customers</div>
            <p className="text-gray-600 text-sm">
          ...
          <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-8 text-center hover:bg-white/80 hover:shadow-xl transition-all duration-300 group">
            ...
            <div className="text-lg font-semibold text-gray-700 mb-3">Success Rate</div>
            <p className="text-gray-600 text-sm">
        ...
        <div className="backdrop-blur-md bg-white/60 border border-white/80 rounded-2xl p-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="bg-[#DB5858]/10 rounded-xl p-4 mb-4 inline-block">
                <Clock className="h-8 w-8 text-[#DB5858]" />
              </div>
              <h4 className="text-lg font-bold text-gray-900 mb-3">Faster Than Competition</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-bold text-gray-900 mb-3">Better Value</h4>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-bold text-gray-900 mb-3">Superior Quality</h4>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
