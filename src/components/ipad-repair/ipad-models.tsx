                ...
                >
                  <div className="flex items-center gap-3 lg:gap-4">
                    <div className="w-10 h-10 lg:w-12 lg:h-12 rounded-lg lg:rounded-xl bg-gradient-to-br from-[#DB5858] to-[#c94848] flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                      <Tablet className="h-5 w-5 lg:h-6 lg:w-6 text-white" />
                    </div>
                    <div>
                      <h3 className="text-sm lg:text-lg font-semibold text-gray-900 group-hover:text-[#DB5858] transition-colors">
                        {model.title}
                      </h3>
                      <p className="text-xs lg:text-sm text-gray-500 mt-1">Expert repair for all models in this series</p>
                    </div>
                  </div>
                  <ChevronDown
                    ...
                    >
                      <div className="px-4 lg:px-6 pb-4 lg:pb-6">
                        <div className="border-t border-white/40 pt-4 lg:pt-6">
                          <p className="text-gray-600 text-xs lg:text-base leading-relaxed mb-4 lg:mb-6">
                            {model.description}
                          </p>

                          <h4 className="font-semibold text-gray-900 mb-2 lg:mb-3 text-xs lg:text-sm">Common Repair Services:</h4>
