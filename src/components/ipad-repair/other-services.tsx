...
import { Smartphone, Laptop, Monitor, Gamepad2, HardDrive, Wifi } from "lucide-react";
...
const otherServices = [
  ...
  },
  {
    ...
    icon: HardDrive,
    title: "Data Recovery",
    description: "Professional data recovery services for tablets, computers, and external storage devices.",
    link: "#" // Will be updated when pages are created
  },
  {
    id: 6,
    icon: Wifi,
    title: "Network Setup",
    description: "Home and business network setup, Wi-Fi troubleshooting, and connectivity solutions.",
    link: "#" // Will be updated when pages are created
  }
];

export function OtherIPadServices() {
  return (
      ...
      <div className="wide-container relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Beyond iPad repair, we fix all your tech devices with the same quality and expertise
          </p>
        </div>
