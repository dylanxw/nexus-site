      ...
      <div className="wide-container relative z-10">
        <div className="text-center">
          <motion.div
            ...
            className="mb-8"
          >
            <div className="inline-flex items-center gap-2 bg-[#DB5858]/10 backdrop-blur-sm border border-[#DB5858]/20 rounded-full px-4 py-2 mb-6">
              <ShoppingBag className="h-4 w-4 text-[#DB5858]" />
              <span className="text-[#DB5858] font-medium text-sm">Quality Pre-Owned Electronics</span>
            </div>
