      ...
      <div className="border-b border-border bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center py-3 text-sm">
            ...
            <ChevronRight className="w-4 h-4 mx-2 text-muted-foreground" />
            <span className="text-muted-foreground">Galaxy S Series</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {filteredPhones.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-muted-foreground text-lg">No Galaxy S models found matching "{searchQuery}"</p>
            <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">Select your Galaxy S model and condition to receive an instant price quote valid for 14 days.</p>
            </motion.div>
            ...
            <div className="prose prose-lg max-w-none text-foreground/80">
              ...
              <div className="grid md:grid-cols-2 gap-8 my-12">
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold text-foreground mb-3">Premium Flagship Values</h3>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold text-foreground mb-3">All Generations Accepted</h3>
                  <p className="text-sm text-muted-foreground">
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold text-foreground mb-3">Ultra Model Premiums</h3>
                  <p className="text-sm text-muted-foreground">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-12">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">Galaxy S Devices Purchased</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-[#DB5858]">$800</p>
                <p className="text-sm text-muted-foreground">Max Galaxy S Value</p>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">Secure Data Wipe</p>
              </div>
            </div>
          </div>
        </div>
