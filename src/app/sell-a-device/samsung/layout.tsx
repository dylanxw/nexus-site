...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://nexustechsolutions.com/sell-a-device/samsung",
    images: [
      {
        url: "/images/sell-a-device/samsung/og-samsung-buyback.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["/images/sell-a-device/samsung/og-samsung-buyback.jpg"],
  },
  alternates: {
    canonical: "/sell-a-device/samsung",
  },
  robots: {
    index: true,
    follow: true,
