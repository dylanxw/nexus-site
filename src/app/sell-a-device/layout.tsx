...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://nexustechsolutions.com/sell-a-device",
    images: [
      {
        url: "/images/sell-a-device/og-buyback.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["/images/sell-a-device/og-buyback.jpg"],
  },
  alternates: {
    canonical: "/sell-a-device",
  },
  robots: {
    index: true,
    follow: true,
