...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `${siteConfig.url}/sell-a-device/iphone`,
    siteName: siteConfig.name,
    locale: "en_US",
    type: "website",
    images: [
      {
        url: `${siteConfig.url}/images/sell-a-device/sell-iphone/apple-iphone-17-pro-max.avif`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [`${siteConfig.url}/images/sell-a-device/sell-iphone/apple-iphone-17-pro-max.avif`],
  },
  alternates: {
    canonical: `${siteConfig.url}/sell-a-device/iphone`,
  },
  robots: {
    index: true,
    follow: true,
