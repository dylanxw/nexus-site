...
export async function generateMetadata({ params }: { params: Promise<{ model: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description: seo.description,
      type: "website",
      url: `https://nexustechsolutions.com/sell-a-device/iphone/${modelSlug}`,
      images: [
        {
          url: `/images/sell-a-device/sell-iphone/apple-${modelSlug}.avif`,
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: seo.title,
      description: seo.description,
      images: [`/images/sell-a-device/sell-iphone/apple-${modelSlug}.avif`],
    },
    alternates: {
      canonical: `/sell-a-device/iphone/${modelSlug}`,
    },
    robots: {
      index: true,
      follow: true,
