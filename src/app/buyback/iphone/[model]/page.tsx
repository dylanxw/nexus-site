...
export default function IPhoneModelPage() {
  ...
  const handleGetPaid = () => {
    ...
    router.push(`/buyback/iphone/${modelSlug}/overview`);
  };
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-8">The iPhone model you're looking for doesn't exist.</p>
            <Link href="/buyback/iphone">
      ...
      <div className="border-b border-gray-200 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center py-3 text-sm">
            ...
            <ChevronRight className="w-4 h-4 mx-2 text-gray-400" />
            <span className="text-gray-600">Sell {modelName}</span>
          </div>
        </div>
      </div>
