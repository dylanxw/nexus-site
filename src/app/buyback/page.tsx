        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">
              Sell Used Phones Online for Cash!
            </h1>
            <p className="text-base md:text-lg text-gray-700 mb-1">
              Find the device you'd like to trade in for cash
            </p>
      ...
      <div className="bg-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 mb-12">
            <p className="mb-6">
              Nexus Tech Solutions is your premier destination for selling used electronics. We've built our reputation
              on offering the highest prices, fastest service, and most secure transactions in the device buyback industry.
              With over 10,000 satisfied customers and millions paid out, we're the trusted choice for turning your old
              devices into instant cash.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 my-12">
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="text-sm">
                  We perform certified data wiping on all devices following Department of Defense standards.
                  Your personal information is completely removed before resale or recycling.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="text-sm">
                  In-store customers receive immediate payment. Mail-in devices are processed within 24 hours
                  of receipt. Choose from cash, check, PayPal, or direct deposit.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="text-sm">
                  Our prices are updated daily based on current market values. We guarantee to match or beat
                  any legitimate competitor's quote for the same device condition.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="text-sm">
                  We provide prepaid shipping labels with full insurance coverage. Your device is protected
                  from the moment you ship it until payment is processed.
                </p>
              </div>
            </div>
            ...
            {[
              {
                ...
                answer: "We buy all types of electronics including smartphones (iPhone, Samsung, etc.), tablets, laptops, smartwatches, gaming consoles, and more. Even broken or water-damaged devices have value!"
              },
              {
              ...
              },
              {
                ...
                answer: "In-store transactions are completed immediately. For mail-in devices, you'll receive payment within 24-48 hours of us receiving your device. Shipping typically takes 2-3 business days."
              },
              {
                question: "What if my device is broken?",
                answer: "We buy devices in any condition! Broken screens, water damage, or devices that won't turn on still have value. Just be honest about the condition when getting your quote."
              },
              {
                question: "How do you determine pricing?",
                answer: "Our prices are based on current market values, device model, storage capacity, carrier compatibility, and condition. We update prices daily to ensure you get the best value."
              },
              {
                question: "Is my personal data safe?",
                answer: "Absolutely. We use Department of Defense standard data wiping procedures. All devices are completely wiped before resale or recycling, ensuring your personal information is permanently removed."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
