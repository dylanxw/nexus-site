...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `${siteConfig.url}/buyback`,
    siteName: siteConfig.name,
    locale: "en_US",
    type: "website",
    images: [
      {
        url: `${siteConfig.url}/images/buyback/categories/sell-iphone.jpg`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [`${siteConfig.url}/images/buyback/categories/sell-iphone.jpg`],
  },
  alternates: {
    canonical: `${siteConfig.url}/buyback`,
  },
  robots: {
    index: true,
    follow: true,
