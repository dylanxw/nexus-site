      ...
      <div className="border-b border-gray-200 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center py-3 text-sm">
            ...
            <ChevronRight className="w-4 h-4 mx-2 text-gray-400" />
            <span className="text-gray-600">Galaxy A Series</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {filteredPhones.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">No Galaxy A models found matching "{searchQuery}"</p>
            <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-sm text-gray-600">Select your Galaxy A model and condition to receive an instant price quote valid for 14 days.</p>
            </motion.div>
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <div className="grid md:grid-cols-2 gap-8 my-12">
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">All A Models Accepted</h3>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Budget-Friendly Buyback</h3>
                  <p className="text-sm text-gray-600">
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Popular Models Premium</h3>
                  <p className="text-sm text-gray-600">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-12">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">A Series Purchased</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-[#DB5858]">30+</p>
                <p className="text-sm text-gray-600">A Models Accepted</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-[#DB5858]">$250</p>
                <p className="text-sm text-gray-600">Max A Series Value</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-[#DB5858]">Same Day</p>
                <p className="text-sm text-gray-600">Payment Available</p>
              </div>
            </div>
          </div>
        </div>
