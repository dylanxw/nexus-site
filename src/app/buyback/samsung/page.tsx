...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `${siteConfig.url}/buyback/samsung`,
    siteName: siteConfig.name,
    locale: "en_US",
    type: "website",
    images: [
      {
        url: `${siteConfig.url}/images/buyback/sell-samsung/galaxy-s-series.avif`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [`${siteConfig.url}/images/buyback/sell-samsung/galaxy-s-series.avif`],
  },
  alternates: {
    canonical: `${siteConfig.url}/buyback/samsung`,
  },
  robots: {
    index: true,
    follow: true,
