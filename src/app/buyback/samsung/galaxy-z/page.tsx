      ...
      <div className="border-b border-gray-200 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center py-3 text-sm">
            ...
            <ChevronRight className="w-4 h-4 mx-2 text-gray-400" />
            <span className="text-gray-600">Galaxy Z Series</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {filteredPhones.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">No Galaxy Z models found matching "{searchQuery}"</p>
            <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-sm text-gray-600">Select your Galaxy Z model and condition to receive an instant price quote valid for 14 days.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-gray-600">Visit our store for immediate payment or use our mail-in service with secure packaging.</p>
            </motion.div>
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <div className="grid md:grid-cols-2 gap-8 my-12">
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Premium Foldable Values</h3>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Fold & Flip Models</h3>
                  <p className="text-sm text-gray-600">
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Screen Condition Matters</h3>
                  <p className="text-sm text-gray-600">
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Special Handling</h3>
                  <p className="text-sm text-gray-600">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-12">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">Foldables Purchased</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-[#DB5858]">$900</p>
                <p className="text-sm text-gray-600">Max Z Fold Value</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-[#DB5858]">Expert</p>
                <p className="text-sm text-gray-600">Foldable Handling</p>
              </div>
              <div className="text-center">
