...
const samsungModelsWithPrices = [
  ...
  // Galaxy Z Series (12 models)
  {
    ...
    image: "/images/buyback/sell-samsung/galaxy-z-fold6.avif",
    maxPrice: 900,
    storage: ["256GB", "512GB", "1TB"],
    popular: true,
  },
  {
    ...
    image: "/images/buyback/sell-samsung/galaxy-z-fold5.avif",
    maxPrice: 750,
    storage: ["256GB", "512GB", "1TB"],
    popular: true,
  },
  {
    ...
    image: "/images/buyback/sell-samsung/galaxy-z-fold4.avif",
    maxPrice: 580,
    storage: ["256GB", "512GB", "1TB"],
  },
  {
    model: "Galaxy Z Fold 3",
    image: "/images/buyback/sell-samsung/galaxy-z-fold3.avif",
    maxPrice: 450,
    storage: ["256GB", "512GB"],
  },
  {
    model: "Galaxy Z Fold 2",
    image: "/images/buyback/sell-samsung/galaxy-z-fold2.avif",
    maxPrice: 350,
    storage: ["256GB", "512GB"],
  },
  {
    model: "Galaxy Z Fold",
    image: "/images/buyback/sell-samsung/galaxy-z-fold.avif",
    maxPrice: 250,
    storage: ["512GB"],
  },
  {
    model: "Galaxy Z Flip 6",
    image: "/images/buyback/sell-samsung/galaxy-z-flip6.avif",
    maxPrice: 650,
    storage: ["256GB", "512GB"],
    popular: true,
  },
  {
    ...
    image: "/images/buyback/sell-samsung/galaxy-z-flip5.avif",
    maxPrice: 550,
    storage: ["256GB", "512GB"],
    popular: true,
  },
  {
    ...
    image: "/images/buyback/sell-samsung/galaxy-z-flip4.avif",
    maxPrice: 380,
    storage: ["128GB", "256GB", "512GB"],
  },
  {
    model: "Galaxy Z Flip 3",
    image: "/images/buyback/sell-samsung/galaxy-z-flip3.avif",
    maxPrice: 280,
    storage: ["128GB", "256GB"],
  },
  {
    model: "Galaxy Z Flip",
    image: "/images/buyback/sell-samsung/galaxy-z-flip.avif",
    maxPrice: 180,
    storage: ["256GB"],
  },
  {
    model: "Galaxy Z Flip 5G",
    image: "/images/buyback/sell-samsung/galaxy-z-flip-5g.avif",
    maxPrice: 200,
    storage: ["256GB"],
  },
  ...
  {
    model: "Galaxy A54",
    image: "/images/buyback/sell-samsung/galaxy-a54.avif",
    maxPrice: 250,
    storage: ["128GB", "256GB"],
    popular: true,
  },
  {
    model: "Galaxy A53",
    image: "/images/buyback/sell-samsung/galaxy-a53.avif",
    maxPrice: 180,
    storage: ["128GB", "256GB"],
    popular: true,
  },
  {
    model: "Galaxy A52",
    image: "/images/buyback/sell-samsung/galaxy-a52.avif",
    maxPrice: 150,
    storage: ["128GB", "256GB"],
  },
  {
    model: "Galaxy A51",
    image: "/images/buyback/sell-samsung/galaxy-a51.avif",
    maxPrice: 120,
    storage: ["128GB"],
  },
  {
    model: "Galaxy A50",
    image: "/images/buyback/sell-samsung/galaxy-a50.avif",
    maxPrice: 90,
    storage: ["64GB", "128GB"],
  },
  {
    model: "Galaxy A34",
    image: "/images/buyback/sell-samsung/galaxy-a34.avif",
    maxPrice: 180,
    storage: ["128GB", "256GB"],
    popular: true,
  },
  {
    model: "Galaxy A33",
    image: "/images/buyback/sell-samsung/galaxy-a33.avif",
    maxPrice: 140,
    storage: ["128GB"],
  },
  {
    model: "Galaxy A32",
    image: "/images/buyback/sell-samsung/galaxy-a32.avif",
    maxPrice: 100,
    storage: ["64GB", "128GB"],
  },
  {
    model: "Galaxy A31",
    image: "/images/buyback/sell-samsung/galaxy-a31.avif",
    maxPrice: 80,
    storage: ["128GB"],
  },
  {
    model: "Galaxy A30",
    image: "/images/buyback/sell-samsung/galaxy-a30.avif",
    maxPrice: 60,
    storage: ["32GB", "64GB"],
  },
  {
    model: "Galaxy A24",
    image: "/images/buyback/sell-samsung/galaxy-a24.avif",
    maxPrice: 140,
    storage: ["128GB"],
  },
  {
    model: "Galaxy A23",
    image: "/images/buyback/sell-samsung/galaxy-a23.avif",
    maxPrice: 110,
    storage: ["64GB", "128GB"],
  },
  {
    model: "Galaxy A22",
    image: "/images/buyback/sell-samsung/galaxy-a22.avif",
    maxPrice: 80,
    storage: ["64GB", "128GB"],
  },
  {
    model: "Galaxy A21",
    image: "/images/buyback/sell-samsung/galaxy-a21.avif",
    maxPrice: 60,
    storage: ["32GB"],
  },
  {
    model: "Galaxy A20",
    image: "/images/buyback/sell-samsung/galaxy-a20.avif",
    maxPrice: 40,
    storage: ["32GB"],
  },
  {
    model: "Galaxy A14",
    image: "/images/buyback/sell-samsung/galaxy-a14.avif",
    maxPrice: 120,
    storage: ["64GB", "128GB"],
  },
  {
    model: "Galaxy A13",
    image: "/images/buyback/sell-samsung/galaxy-a13.avif",
    maxPrice: 90,
    storage: ["32GB", "64GB", "128GB"],
  },
  {
    model: "Galaxy A12",
    image: "/images/buyback/sell-samsung/galaxy-a12.avif",
    maxPrice: 70,
    storage: ["32GB", "64GB", "128GB"],
  },
  {
    model: "Galaxy A11",
    image: "/images/buyback/sell-samsung/galaxy-a11.avif",
    maxPrice: 50,
    storage: ["32GB"],
  },
  {
    model: "Galaxy A10",
    image: "/images/buyback/sell-samsung/galaxy-a10.avif",
    maxPrice: 35,
    storage: ["32GB"],
  },
  {
    model: "Galaxy A04",
    image: "/images/buyback/sell-samsung/galaxy-a04.avif",
    maxPrice: 60,
    storage: ["32GB", "64GB"],
  },
  {
    model: "Galaxy A03",
    image: "/images/buyback/sell-samsung/galaxy-a03.avif",
    maxPrice: 40,
    storage: ["32GB", "64GB"],
  },
  {
    model: "Galaxy A02",
    image: "/images/buyback/sell-samsung/galaxy-a02.avif",
    maxPrice: 30,
    storage: ["32GB"],
  },
  {
    model: "Galaxy A01",
    image: "/images/buyback/sell-samsung/galaxy-a01.avif",
    maxPrice: 25,
    storage: ["16GB", "32GB"],
  },
  {
    model: "Galaxy A73",
    image: "/images/buyback/sell-samsung/galaxy-a73.avif",
    maxPrice: 200,
    storage: ["128GB", "256GB"],
  },
  {
    model: "Galaxy A72",
    image: "/images/buyback/sell-samsung/galaxy-a72.avif",
    maxPrice: 160,
    storage: ["128GB", "256GB"],
  },
  {
    model: "Galaxy A71",
    image: "/images/buyback/sell-samsung/galaxy-a71.avif",
    maxPrice: 130,
    storage: ["128GB"],
  },
  {
    model: "Galaxy A70",
    image: "/images/buyback/sell-samsung/galaxy-a70.avif",
    maxPrice: 100,
    storage: ["128GB"],
  },
  {
    model: "Galaxy A80",
    image: "/images/buyback/sell-samsung/galaxy-a80.avif",
    maxPrice: 110,
    storage: ["128GB"],
  },
  {
    model: "Galaxy A90",
    image: "/images/buyback/sell-samsung/galaxy-a90.avif",
    maxPrice: 120,
    storage: ["128GB"],
  },
];
...
export default function SamsungModelPage() {
  ...
  const handleGetPaid = () => {
    ...
    router.push(`/buyback/samsung/${modelSlug}/overview`);
  };
          ...
          <div className="bg-white rounded-lg p-6">
            ...
            <div className="mb-6">
              <div className="flex items-center gap-2 mb-3">
                <span className="text-sm font-semibold text-gray-700">Network Carrier</span>
            ...
            <div className="mb-6">
              <div className="flex items-center gap-2 mb-3">
                <span className="text-sm font-semibold text-gray-700">Storage Capacity</span>
                <div className="bg-[#DB5858] text-white rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold">!</div>
              </div>
              <div className="flex flex-wrap gap-2">
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                <span className="text-sm font-semibold text-gray-700">Device Condition</span>
                <div className="bg-[#DB5858] text-white rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold">!</div>
              </div>
              <div className="flex flex-wrap gap-2">
          ...
          <div className="bg-white rounded-lg p-6">
            <div className="text-center">
              ...
              {canGetQuote && quoteData ? (
                ...
                <>
                  <div className="text-5xl font-bold text-gray-300 mb-6">
                    $--
                  </div>

                  <Button
                    disabled
                    className="w-full bg-gray-300 text-gray-500 py-4 text-lg font-semibold cursor-not-allowed"
                  >
                    Get Paid
                  </Button>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-12">
              <div className="text-center">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Best Local Prices</h3>
                <p className="text-sm text-gray-600">
            ...
            <div className="border-t pt-12">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="relative">
                  ...
                  <div className="pl-6">
                    <h4 className="font-semibold text-gray-900 mb-2">Get Your Quote</h4>
                    <p className="text-sm text-gray-600">
                ...
                <div className="relative">
                  ...
                  <div className="pl-6">
                    <h4 className="font-semibold text-gray-900 mb-2">Prepare Your Device</h4>
                    <p className="text-sm text-gray-600">
